 ...
 * @author amnesia
 */
public class DaftarPegawaiAktifSajaUI extends javax.swing.JFrame {
     ...
     */
    public DaftarPegawaiAktifSajaUI() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:        
        new PrintReport("./report/daftar_pegawai_komplit.jasper", null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DaftarPegawaiAktifSajaUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DaftarPegawaiAktifSajaUI().setVisible(true);
            }
        });
    }
