...
import com.init.provinsi.Provinsi;
import com.init.provinsi.ProvinsiTabelModel;
 ...
 */
public class ProvinsiUI extends javax.swing.JFrame {
    ...
    private void showProvinsi(){
        ProvinsiTabelModel ctm = new ProvinsiTabelModel(DaoFactory.getProvinsiDao().getAllProvinsi());
        tabelprovinsi.setModel(ctm);
        tabelprovinsi.setRowSorter(sorter);
        tabelprovinsi.getColumnModel().getColumn(0).setPreferredWidth(50);
        tabelprovinsi.getColumnModel().getColumn(1).setPreferredWidth(60);
        tabelprovinsi.getColumnModel().getColumn(2).setPreferredWidth(540);
    }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String kodeprovinsi = txtNo.getText();
        String namaprovinsi = txtNama.getText();
        if (!"".equals(kodeprovinsi)) {
            Provinsi provinsi = DaoFactory.getProvinsiDao().getProvinsiByKode(kodeprovinsi);
            if (provinsi!=null) {
                int id = provinsi.getID();
    ...
    private void tabelprovinsiMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelprovinsiMouseClicked
        // TODO add your handling code here:
        int row = tabelprovinsi.getSelectedRow();
        if (row>=0) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (!"".equals(txtNo.getText())) {
            Provinsi c = DaoFactory.getProvinsiDao().getProvinsiByKode(txtNo.getText());
            if (c!=null) {
                DaoFactory.getProvinsiDao().DeleteProvinsiByID(c);
                showProvinsi();
                clearField();
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProvinsiUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new ProvinsiUI().setVisible(true);
            }
        });
    }
